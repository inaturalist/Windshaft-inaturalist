...
var defaultPlaceConfirmedColor = "#088A08";
...
inaturalist.taxonPlacesRequest = function(req, callback) {
  ...
  var query = squel.select()
    ...
    .group("geom")
  req.params.sql = "(" + query.toString() + ") AS places";
  var unconfirmedColor = req.params.unconfirmedColor ? req.params.unconfirmedColor : defaultPlaceUnconfirmedColor;
  req.params.style = req.params.style.replace(/\{\{unconfirmed-color\}\}/g, unconfirmedColor);
  var confirmedColor = req.params.confirmedColor ? req.params.confirmedColor : defaultPlaceConfirmedColor;
